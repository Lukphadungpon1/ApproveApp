...
class prapprovedAC extends StatelessWidget {
  ...
  prapprovedAC({required this.PRNumber, required this.types});
    ...
    if (formKey.currentState!.validate()) {
      ...
      if (_status == '"Approved"' ||
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Can\'t Approve Please contract IT..'),
          ),
        );
      }
    }
