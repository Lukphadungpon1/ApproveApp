...
import 'package:prsystem/ui/prSearch.dart';
import 'package:prsystem/ui/prdetail.dart';
...
class _mainPageScreenState extends State<mainPageScreen> {
  ...
  Widget PRList() {
    return Consumer<PRListProvider>(
        builder: (BuildContext context, PRListProvider provider, _) {
